...
import com.sparta.apiminiproject.pojos.ErrorResponse;
...
//                .log().all()
        ...
        errorResponse = mapper.readValue(errorResponseString, ErrorResponse.class);
    }

    @Test
    void postAllProductsList_Returns405ResponseCode() {
        MatcherAssert.assertThat(errorResponse.getResponseCode(), Matchers.is(405));
    }
